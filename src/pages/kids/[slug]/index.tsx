...
const KidsCategory = ({ products }: { products: Product[] }) => {
  return (
...
export const getStaticPaths = (async () => {
  ...
  const result = await client.query(
    "SELECT category_url FROM product_category WHERE product_collection_id = 4"
  );
  client.release();
...
KidsCategory.PageLayout = CollectionLayout;
